...
data_full_hisp <- left_join(data_full,seer_data_modified, by = c("FIPS" = "FIPS", "YEAR_DX" = "Year"))
...
# Assign column names
colnames(data_full_hisp) <- c("FIPS","YEAR_DX","CL_CASES","C",
                              "POP")
...
save(data_full_hisp_noZero, file = file.path(DATA_DIR, paste0('total_Lymphoma_',years[1],'_',years[length(years)],'_0-29.RData')))

# Print summary statistics
cat("Sensitivity analysis total population data cleaning completed!\n")
